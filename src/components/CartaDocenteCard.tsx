    ...
    <section className="w-full bg-transparent py-4 text-zinc-800">
      <div className="w-full lg:w-[60%] mx-auto px-4 lg:px-4">
        ...
        >
          ...
          {/* Footer Bar with Scopri di più > link */}
          <div className="bg-blue-50/50 border-t border-blue-100/80 px-5 md:px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-left">
            ...
            <span className="text-xs font-bold text-orange-600 group-hover:text-orange-700 transition-colors uppercase tracking-wider flex items-center gap-1 whitespace-nowrap shrink-0 sm:ml-auto font-sans">
              Scopri di più &gt;
            </span>
          </div>
        </Link>
