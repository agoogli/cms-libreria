...
export default function CarteCulturaPage() {
  return (
    <PageWrapper title="Carte Cultura 2026">
      {/* Section 1 */}
      <section className="bg-white p-5 rounded-xl border border-zinc-200/80 shadow-sm">
        ...
        <p className="mb-2 text-xs text-zinc-600 leading-relaxed font-sans">
        ...
        <ul className="list-disc pl-4 flex flex-col gap-1.5 text-xs text-zinc-500 font-sans">
          <li>
