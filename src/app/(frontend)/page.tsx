    ...
    <>
      ...
      <section className="w-full bg-transparent py-4 text-zinc-800">
        <div className="w-full lg:w-[60%] mx-auto px-4 lg:px-4">
          <div className="bg-white rounded-xl border border-zinc-200/80 shadow-sm p-5 md:p-6 flex flex-col md:flex-row md:items-stretch gap-6 divide-y md:divide-y-0 md:divide-x divide-zinc-200">
            ...
            <div className="flex-1 flex gap-3.5 items-start pt-5 md:pt-0 md:pl-6">
              <div className="w-10 h-10 rounded-full bg-orange-50 text-orange-600 flex items-center justify-center shrink-0 mt-0.5">
                <svg className="w-5 h-5 fill-currentColor" viewBox="0 0 24 24">
          ...
          {/* Box 3: Note su Disponibilità */}
          <div className="mt-3 bg-orange-50/60 rounded-lg border border-orange-100/80 p-3 flex items-center gap-2.5">
            <div className="w-5 h-5 rounded-full bg-orange-100 flex items-center justify-center shrink-0">
              <svg className="w-3.5 h-3.5 text-orange-600 fill-currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" />
              </svg>
            </div>
            <p className="text-xs text-orange-850 font-sans font-medium">
