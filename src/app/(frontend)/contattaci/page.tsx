...
export default function ContattaciPage() {
  return (
    <div className="w-full lg:w-[60%] mx-auto px-4 py-8 flex flex-col gap-6">
      ...
      {/* Catchy Subtitle matching home description style */}
      <p className="text-[11px] text-zinc-500 -mt-2 leading-relaxed font-sans opacity-95">
        Siamo sempre a tua disposizione per informazioni sulla disponibilità dei libri, prenotazioni scolastiche o consigli di lettura. Scegli il metodo che preferisci.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
        ...
        >
          ...
          <span className="text-[11px] text-zinc-600 mt-1 font-sans">090 71 0469</span>
          <span className="text-[9px] text-zinc-400 mt-2 font-sans group-hover:text-orange-500 transition-colors">Chiama ora</span>
        </a>
        ...
        >
          ...
          <span className="text-[11px] text-zinc-600 mt-1 font-sans">327 66 87 839</span>
          <span className="text-[9px] text-zinc-400 mt-2 font-sans group-hover:text-green-500 transition-colors">Invia un messaggio</span>
        </a>
        ...
        >
          ...
          <span className="text-[11px] text-zinc-600 mt-1 font-sans break-all max-w-full px-1">librerianunnari@gmail.com</span>
          <span className="text-[9px] text-zinc-400 mt-2 font-sans group-hover:text-orange-500 transition-colors">Scrivici una mail</span>
        </a>
      </div>
    </div>
  )
